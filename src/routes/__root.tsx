...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Pick your gender, age and start chatting anonymously." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "theme-color", content: "#1a1226" },
      { name: "twitter:title", content: "TalkMe — Anonymous chat" },
      { name: "twitter:description", content: "Pick your gender, age and start chatting anonymously." },
